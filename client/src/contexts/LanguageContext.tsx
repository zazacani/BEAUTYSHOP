...
const translations = {
  ...
  de: {
    ...
    "cart.authRequired": "Authentifizierung erforderlich",
    "cart.pleaseLogin": "Bitte melden Sie sich an, um fortzufahren",
    
    // Payment
    "checkout.title": "Bezahlung",
    "checkout.orderSummary": "Bestellübersicht",
    "checkout.paymentDetails": "Zahlungsinformationen",
    "checkout.securePayment": "Sichere Zahlung mit Stripe",
    "checkout.quantity": "Menge",
    "checkout.total": "Gesamt",
    "checkout.payNow": "Jetzt bezahlen",
    "checkout.processing": "Verarbeitung...",
    "checkout.confirmingOrder": "Bestätigung Ihrer Bestellung...",
    "checkout.loading": "Zahlung wird initialisiert...",
    "checkout.error": "Fehler",
    "checkout.paymentFailed": "Zahlung fehlgeschlagen",
    "checkout.paymentSuccess": "Zahlung erfolgreich!",
    "checkout.orderConfirmed": "Ihre Bestellung wurde bestätigt",
    "checkout.orderCreationFailed": "Bestellung konnte nicht erstellt werden",
    "checkout.noPaymentIntent": "Zahlungsinformationen fehlen",
    "checkout.orderNumber": "Bestellnummer",
    "checkout.somethingWentWrong": "Ein Fehler ist aufgetreten",
    "checkout.tryAnotherCard": "Mit einer anderen Karte bezahlen",
    "checkout.shippingAddress": "Lieferadresse",
    "checkout.enterShippingDetails": "Geben Sie Ihre Lieferadresse ein",
    "checkout.firstName": "Vorname",
    "checkout.firstNamePlaceholder": "Hans",
    "checkout.lastName": "Nachname",
    "checkout.lastNamePlaceholder": "Müller",
    "checkout.address": "Adresse",
    "checkout.addressPlaceholder": "Bahnhofstrasse 15",
    "checkout.addressLine2": "Adresszusatz",
    "checkout.addressLine2Placeholder": "Wohnung, Etage, etc.",
    "checkout.city": "Stadt",
    "checkout.cityPlaceholder": "Zürich",
    "checkout.postalCode": "Postleitzahl",
    "checkout.postalCodePlaceholder": "8000",
    "checkout.country": "Land",
    "checkout.addressRequired": "Bitte füllen Sie alle Pflichtfelder aus",
