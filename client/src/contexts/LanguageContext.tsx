...
const translations = {
  ...
  de: {
    ...
    "checkout.otherCountry": "Anderes Land",
    ...
    "myOrders.noOrders": "Sie haben noch keine Bestellung aufgegeben",
    "myOrders.orderNumber": "Bestellung Nr.",
    "myOrders.date": "Datum",
    "myOrders.status": "Status",
    "myOrders.total": "Gesamt",
    "myOrders.items": "Artikel",
    "myOrders.shippingAddress": "Lieferadresse",
    "myOrders.trackingNumber": "Sendungsnummer",
    "myOrders.noTracking": "Noch nicht verfügbar",
    "myOrders.status.PENDING": "Ausstehend",
    "myOrders.status.CONFIRMED": "Bestätigt",
    "myOrders.status.SHIPPED": "Versandt",
    "myOrders.status.DELIVERED": "Zugestellt",
    "myOrders.status.CANCELLED": "Storniert",
    ...
    "reviews.commentPlaceholder": "Teilen Sie Ihre Erfahrung mit diesem Produkt (mindestens 10 Zeichen)",
    ...
    "reviews.error": "Fehler beim Veröffentlichen der Bewertung",
    "reviews.alreadyReviewed": "Sie haben bereits eine Bewertung für dieses Produkt abgegeben",
    "reviews.mustPurchase": "Sie müssen dieses Produkt kaufen, um eine Bewertung abzugeben",
    "reviews.by": "von",
